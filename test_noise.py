...
parser = argparse.ArgumentParser(description='Testing for MMSol Noise')
...
class Ecoli(MMSol_Dataset):
    ...
    def test(self, model=None):         
        ...
        test_dataset = MMSol_Dataset(self.test_dataset, max_pad_len=self.max_pad_len, 
                                     edge_fea_path='./data/noise/noise_graph/test_LPE_5_1.pkl', 
                                     node_fea_path='./data/noise/noise_graph/test_node.pkl', 
