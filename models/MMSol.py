...
class Model_wo_seq(nn.Module):
    ...
    def __init__(self, hidden_size=36, ffn_size=256, dropout_rate=0.1, attention_dropout_rate=0.1,
        ...
        self.fusion_layer = nn.Linear(164-32-64, 128)
        self.fc = nn.Linear(128, num_labels)
        self.relu = nn.ReLU()  
...
class Model_wo_stru(nn.Module):
    ...
    def __init__(self, hidden_size=36, ffn_size=256, dropout_rate=0.1, attention_dropout_rate=0.1,
        ...
        self.fusion_layer = nn.Linear(164-36, 128)
        self.fc = nn.Linear(128, num_labels)
        self.relu = nn.ReLU()  
...
class Model_wo_func(nn.Module):
    ...
    def __init__(self, hidden_size=36, ffn_size=256, dropout_rate=0.1, attention_dropout_rate=0.1,
        ...
        self.fusion_layer = nn.Linear(164-32, 128)
        self.fc = nn.Linear(128, num_labels)
        self.relu = nn.ReLU()  
...
class Model_seq(nn.Module):
    ...
    def __init__(self, hidden_size=36, ffn_size=256, dropout_rate=0.1, attention_dropout_rate=0.1,
        ...
        self.fusion_layer = nn.Linear(32+64, 128)
        self.fc = nn.Linear(128, num_labels)
        self.relu = nn.ReLU()  
...
class Model_stru(nn.Module):
    ...
    def __init__(self, hidden_size=36, ffn_size=256, dropout_rate=0.1, attention_dropout_rate=0.1,
        ...
        self.fusion_layer = nn.Linear(36, 128)
        self.fc = nn.Linear(128, num_labels)
        self.relu = nn.ReLU()  
...
class Model_func(nn.Module):
    ...
    def __init__(self, hidden_size=36, ffn_size=256, dropout_rate=0.1, attention_dropout_rate=0.1,
        ...
        self.fusion_layer = nn.Linear(32, 128)
        self.fc = nn.Linear(128, num_labels)
        self.relu = nn.ReLU()  
