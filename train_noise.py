...
from config import config_noise
...
parser.add_argument('--test_dataset_path', default=config_noise.test_dataset_path, type=str, help='Path for test dataset')
...
class Ecoli(MMSol_Dataset):
    ...
    def train(self):
        ...
        train_dataset = MMSol_Dataset(self.train_dataset, max_pad_len=self.max_pad_len, 
                                      edge_fea_path='./data/noise/noise_edge/train_LPE_5_1.pkl', 
                                      node_fea_path='./data/noise/noise_edge/train_node.pkl', 
    ...
    def valid(self, model=None):         
        ...
        val_dataset = MMSol_Dataset(self.valid_dataset, max_pad_len=self.max_pad_len, 
                                    edge_fea_path='./data/noise/noise_edge/valid_LPE_5_1.pkl', 
                                    node_fea_path='./data/noise/noise_edge/valid_node.pkl', 
    ...
    def test(self, model=None):         
        ...
        test_dataset = MMSol_Dataset(self.test_dataset, max_pad_len=self.max_pad_len, 
                                     edge_fea_path='./data/noise/noise_edge/test_LPE_5_1.pkl', 
                                     node_fea_path='./data/noise/noise_edge/test_node.pkl', 
                                     GO_fea_path='./data/noise/noise_go/test_go.pkl')
